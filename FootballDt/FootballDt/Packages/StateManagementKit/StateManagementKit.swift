...
public final class TaskManager {
    ...
    public func run(id: String, priority: TaskPriority = .userInitiated, operation: @escaping () async throws -> Void) {
        cancel(id: id)
...
public protocol DataSourceProtocol<Model> {
...
public protocol PersistenceProtocol<Model> {
...
public struct UserDefaultsPersistence<Model: Codable>: PersistenceProtocol {
    public init() {}
...
public class StateStore<Model: Identifiable & Equatable>: ObservableObject {
    ...
    public func loadPage(
        ...
        append: Bool = false,
        retryPolicy: RetryPolicy = .default,
        operation: @escaping (Int, Int) async throws -> [Model]
    ) async {
